...
$("#pageone").bind("pageshow", function(e) {
	...
	$("#searchField_vegetables6").autocomplete({
		...
		callback: function(e){
		    ...
		    $('#searchField_vegetables6').val($a.text()); // place the value of the selection into the search box
	...
	$("#searchField_vegetables7").autocomplete({
		...
		callback: function(e){
		    ...
		    $('#searchField_vegetables7').val($a.text()); // place the value of the selection into the search box
	...
	$("#searchField_vegetables8").autocomplete({
		...
		callback: function(e){
		    ...
		    $('#searchField_vegetables8').val($a.text()); // place the value of the selection into the search box
	...
	$("#searchField_vegetables9").autocomplete({
		...
		callback: function(e){
		    ...
		    $('#searchField_vegetables9').val($a.text()); // place the value of the selection into the search box
	...
	$("#searchField_vegetables10").autocomplete({
		...
		callback: function(e){
		    ...
		    $('#searchField_vegetables10').val($a.text()); // place the value of the selection into the search box
