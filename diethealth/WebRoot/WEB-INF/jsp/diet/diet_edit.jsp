			...
			<div data-role="collapsible">
				...
				<div id="meat">
					...
					<div data-role="fieldcontain" name="meatnum" id="meatnums1">
						<label for="number">食量（克）：</label> <input type="range"
							name="number" id="meatnum1" required="true" value="200" min="0"
							max="1000">
					</div>
					...
					<div data-role="fieldcontain" name="meatnum" id="meatnums2"
						style="display: none">
						<label for="number">食量（克）：</label> <input type="range"
							name="number" id="meatnum2" required="true" value="200" min="0"
							max="1000">
					</div>
					...
					<div data-role="fieldcontain" name="meatnum" id="meatnums3"
						style="display: none">
						<label for="number">食量（克）：</label> <input type="range"
							name="number" id="meatnum3" required="true" value="200" min="0"
							max="1000">
					</div>
					...
					<div data-role="fieldcontain" name="meatnum" id="meatnums4"
						style="display: none">
						<label for="number">食量（克）：</label> <input type="range"
							name="number" id="meatnum4" required="true" value="200" min="0"
							max="1000">
					</div>
					...
					<div data-role="fieldcontain" name="meatnum" id="meatnums5"
						style="display: none">
						<label for="number">食量（克）：</label> <input type="range"
							name="number" id="meatnum5" required="true" value="200" min="0"
							max="1000">
					</div>
			...
			<div data-role="collapsible">
				...
				<div id="vegetables">
					...
					<div data-role="fieldcontain" name="vegetablesnum"
						id="vegetablesnums1">
						<label for="number">食量（克）：</label> <input type="range"
							name="number" id="vegetablesnum1" required="true" value="200"
							min="0" max="1000">
					</div>
					...
					<div data-role="fieldcontain" name="vegetablesnum"
						...
						<label for="number">食量（克）：</label> <input type="range"
							name="number" id="vegetablesnum2" required="true" value="200"
							min="0" max="1000">
					</div>
					...
					<div data-role="fieldcontain" name="vegetablesnum"
						...
						<label for="number">食量（克）：</label> <input type="range"
							name="number" id="vegetablesnum3" required="true" value="200"
							min="0" max="1000">
					</div>
					...
					<div data-role="fieldcontain" name="vegetablesnum"
						...
						<label for="number">食量（克）：</label> <input type="range"
							name="number" id="vegetablesnum4" required="true" value="200"
							min="0" max="1000">
					</div>
					...
					<div data-role="fieldcontain" name="vegetablesnum"
						...
						<label for="number">食量（克）：</label> <input type="range"
							name="number" id="vegetablesnum5" required="true" value="200"
							min="0" max="1000">
					</div>
					...
					<div data-role="fieldcontain" name="vegetablesnum"
						...
						<label for="number">食量（克）：</label> <input type="range"
							name="number" id="vegetablesnum6" required="true" value="200"
							min="0" max="1000">
					</div>
					...
					<div data-role="fieldcontain" name="vegetablesnum"
						...
						<label for="number">食量（克）：</label> <input type="range"
							name="number" id="vegetablesnum7" required="true" value="200"
							min="0" max="1000">
					</div>
					...
					<div data-role="fieldcontain" name="vegetablesnum"
						...
						<label for="number">食量（克）：</label> <input type="range"
							name="number" id="vegetablesnum8" required="true" value="200"
							min="0" max="1000">
					</div>
					...
					<div data-role="fieldcontain" name="vegetablesnum"
						...
						<label for="number">食量（克）：</label> <input type="range"
							name="number" id="vegetablesnum9" required="true" value="200"
							min="0" max="1000">
					</div>
					...
					<div data-role="fieldcontain" name="vegetablesnum"
						...
						<label for="number">食量（克）：</label> <input type="range"
							name="number" id="vegetablesnum10" required="true" value="200"
							min="0" max="1000">
					</div>
			...
			<div data-role="collapsible">
				...
				<div id="drink">
					...
					<div data-role="fieldcontain" name="drinknum" id="drinknums1">
						<label for="number">食量（克）：</label> <input type="range"
							name="number" id="drinknum1" required="true" value="200" min="0"
							max="1000">
					</div>
					...
					<div data-role="fieldcontain" name="drinknum" id="drinknums2"
						style="display: none">
						<label for="number">食量（克）：</label> <input type="range"
							name="number" id="drinknum2" required="true" value="200" min="0"
							max="1000">
					</div>
					...
					<div data-role="fieldcontain" name="drinknum" id="drinknums3"
						style="display: none">
						<label for="number">食量（克）：</label> <input type="range"
							name="number" id="drinknum3" required="true" value="200" min="0"
							max="1000">
					</div>
					...
					<div data-role="fieldcontain" name="drinknum" id="drinknums4"
						style="display: none">
						<label for="number">食量（克）：</label> <input type="range"
							name="number" id="drinknum4" required="true" value="200" min="0"
							max="1000">
					</div>
					...
					<div data-role="fieldcontain" name="drinknum" id="drinknums5"
						style="display: none">
						<label for="number">食量（克）：</label> <input type="range"
							name="number" id="drinknum5" required="true" value="200" min="0"
							max="1000">
					</div>
			...
			<div data-role="collapsible">
				...
				<div id="nut">
					...
					<div data-role="fieldcontain" name="nutnum" id="nutnums1">
						<label for="number">食量（克）：</label> <input type="range"
							name="number" id="nutnum1" required="true" value="200" min="0"
							max="1000">
					</div>
					...
					<div data-role="fieldcontain" name="nutnum" id="nutnums2"
						style="display: none">
						<label for="number">食量（克）：</label> <input type="range"
							name="number" id="nutnum2" required="true" value="200" min="0"
							max="1000">
					</div>
					...
					<div data-role="fieldcontain" name="nutnum" id="nutnums3"
						style="display: none">
						<label for="number">食量（克）：</label> <input type="range"
							name="number" id="nutnum3" required="true" value="200" min="0"
							max="1000">
					</div>
					...
					<div data-role="fieldcontain" name="nutnum" id="nutnums4"
						style="display: none">
						<label for="number">食量（克）：</label> <input type="range"
							name="number" id="nutnum4" required="true" value="200" min="0"
							max="1000">
					</div>
					...
					<div data-role="fieldcontain" name="nutnum" id="nutnums5"
						style="display: none">
						<label for="number">食量（克）：</label> <input type="range"
							name="number" id="nutnum5" required="true" value="200" min="0"
							max="1000">
					</div>
			...
			<div data-role="collapsible">
				...
				<div id="fruits">
					...
					<div data-role="fieldcontain" name="fruitsnum" id="fruitsnums1">
						<label for="number">食量（克）：</label> <input type="range"
							name="number" id="fruitsnum1" required="true" value="200" min="0"
							max="1000">
					</div>
					...
					<div data-role="fieldcontain" name="fruitsnum" id="fruitsnums2"
						style="display: none">
						<label for="number">食量（克）：</label> <input type="range"
							name="number" id="fruitsnum2" required="true" value="200" min="0"
							max="1000">
					</div>
					...
					<div data-role="fieldcontain" name="fruitsnum" id="fruitsnums3"
						style="display: none">
						<label for="number">食量（克）：</label> <input type="range"
							name="number" id="fruitsnum3" required="true" value="200" min="0"
							max="1000">
					</div>
					...
					<div data-role="fieldcontain" name="fruitsnum" id="fruitsnums4"
						style="display: none">
						<label for="number">食量（克）：</label> <input type="range"
							name="number" id="fruitsnum4" required="true" value="200" min="0"
							max="1000">
					</div>
					...
					<div data-role="fieldcontain" name="fruitsnum" id="fruitsnums5"
						style="display: none">
						<label for="number">食量（克）：</label> <input type="range"
							name="number" id="fruitsnum5" required="true" value="200" min="0"
							max="1000">
					</div>
